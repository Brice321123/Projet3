		...
		<center>
			...
			if (isset($_SESSION["iduser"]) && $_SESSION["iduser"] == 1) {
				...
				if (isset($_POST['supprimer'])) {
						...
						$_SESSION['Champ4']="";
						$_SESSION['Champx']="";
						$unControleur->delete($_SESSION['Champ0'],'id_vo',$_POST["idsupp"]);
				}elseif (isset($_POST['valider']) || isset($_POST['modifier'])) {//Sauvegarde champs
						$_SESSION['Champ1'] = $_POST['id_vo'];
						$_SESSION['Champ2'] = $_POST['nom_vo'];
						$_SESSION['Champ3'] = $_POST['reduction_vo'];
						$_SESSION['Champ4'] = $_POST['id_re'];
					if  (empty($_POST['nom_vo']) || empty($_POST['id_re'])) {
						...
						if (isset($_POST['valider'])) {//verif si pas de doublon
							$res = $unControleur->selectOne($_SESSION['Champ0'],'id_vo',$_SESSION['Champ1']);
								if ($res) {//Doublon
									echo "<div class='alert alert-danger' role='alert'>";
									echo "<strong>"; 
									echo $_SESSION['Champ4']." déjà crée";
									echo "</strong>";
									echo "</div>";							
								}else {//Création OK
									$_SESSION['Champ1']="";
								...
								$res = $unControleur->selectOne($_SESSION['Champ0'],'id_re',$_SESSION['Champ4']);
					...
					$res = $unControleur->selectOne($_SESSION['Champ0'],'id_vo',$_GET['idt']);
					$_SESSION['Champ1'] = $res['id_vo'];
					$_SESSION['Champ2'] = $res['nom_vo'];
					$_SESSION['Champ3'] = $res['reduction_vo'];
					$_SESSION['Champ4'] = $res['id_re'];
